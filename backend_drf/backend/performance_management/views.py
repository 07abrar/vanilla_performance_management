...
# NOTE: after creating serializers, create viewsets for User, Activity, and Track models
...
from .serializers import UserSerializer, ActivitySerializer, TrackSerializer, TrackDetailSerializer
...
def recap_view(request, mode):
    """
    Custom API view for recap data aggregation
    Supports modes: daily, weekly, monthly
    Reads query parameters: date, week_start, year, month
    Returns RecapOut structure matching frontend expectations
    """
    try:
        ...
        if mode == 'daily':
            ...
            if week_start_param:
                ...
                start_date = datetime.fromisoformat(week_start_param.replace('Z', '+00:00'))
