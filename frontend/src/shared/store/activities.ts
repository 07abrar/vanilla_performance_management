...
import { CreateActivityPayload, Entity } from 'shared/api/types';
...
export const activitiesState: ResourceState<Entity[]> = {
  data: [],
  isLoading: false,
  error: null
};

export function getActivitiesState(): ResourceState<Entity[]> {
